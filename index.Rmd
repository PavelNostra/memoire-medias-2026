...
header-includes:
  ...
  - \newtcolorbox[auto counter, number within=chapter]{methodo}[1][]{colback=black!5, colframe=black, coltitle=white, fonttitle=\bfseries, title={Encadré méthodologique \thetcbcounter~: #1}}
output:
  bookdown::pdf_book:
    toc: no
    toc_depth: 3
